$(window).load(function(){
    ...
    var createGoals = function(data){
		...
		for ( var i = 0; i < data.length; i++ ) {
			$( '<div class="col-xs-4 col-sm-2 col-md-2 goalButton" id='+data[i].taskID+'><p class="center">'+data[i].taskDescription+'</p><div class="taskPoints">'+data[i].taskPoints+'</div></div>' ).appendTo( ".goalGrid" );
		}
		chooseGoal();
	}
