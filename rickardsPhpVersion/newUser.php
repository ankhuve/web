...
<body>
	...
	<div class="container-fluid">
		...
		<form action="validateNewUser.php" method="post">
			...
			<div class="row">
				<div class="col-xs-8 col-xs-offset-2">
					<center><input class="btn" type="submit" value="Create new user!"></center>
				</div>
			</div>
		</form>
...
<?php 
    $available = $_SESSION['usernameAvailable'];
    if($available == "not available"){
    	echo "<div class='row'>";
    	echo "<div class='col-xs-8 col-xs-offset-2'>";
    	echo "<center> Username was not available, please pick another one!</center>";
    	echo "</div>";
    	echo "</div>";
    }
?>
